...
local UserName = (data.username_ or "ROLEX_TEAM")
...
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ◈︙[تحديثات البوت](t.me/ROLEX_TEAM) \n◈︙[قناه السورس](t.me/T_aLeN)')
end
...
usertext = '*\n ◈︙اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'ROLEX_TEAM')..')'
status  = '\n *◈︙تم ترقيته مطور*'
...
usertext = '\n *◈︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'ROLEX_TEAM')..')'
status  = '\n*◈︙تم ترقيته مطور*'
...
if ROLEX1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *◈︙اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ROLEX_TEAM')..') \n ◈︙'..ROLEX1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
send(msg.chat_id_,0," *◈︙العضو :* {["..data.first_name_.."](T.ME/ROLEX_TEAM)}\n◈︙["..ROLEX_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *◈︙عذرا ↫* {["..data.first_name_.."](T.ME/ROLEX_TEAM)}\n*◈︙عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄʀ ʀᴏʟᴇх\n\n[◈  ʀᴏʟᴇх ᴄʜᴀɴɴᴇʟ](http://t.me/T_aLeN)\n\n[◈  ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/ROLEX_TEAM)\n\n[◈  ʀᴏʟᴇх ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/XCGCC)\n\n[◈  ʙᴏᴛ ʀᴏʟᴇх](http://t.me/XCGCCBOT)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '◈ sᴏᴜʀᴄʀ ʀᴏʟᴇх',url="t.me/ROLEX_TEAM/906"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/ROLEX_TEAM&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, '*◈︙بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ROLEX_TEAM')..') \n*◈︙تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *◈︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'ROLEX_TEAM')..') \n*◈︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
local TextE = "\n*•━━━━━━ 𝙍𝙤𝙡𝙚𝙭 ━━━━━━━•*\n *◈︙علامة تعني { ✓ } ملف مفعل*\n *◈︙علامة تعني { ✘ } ملف معطل*\n *◈︙قناة سورس روليكس ↓*\n".." *◈︙*[اضغط هنا لدخول](t.me/ROLEX_TEAM) \n"
local NumFile = 0
...
local UserName = (b.username_ or "ROLEX_TEAM")
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *◈︙العضو* » ['..data.first_name_..'](t.me/'..(data.username_ or 'ROLEX_TEAM')..')'
status  = '\n*◈︙تم ترقيته ادمن*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *◈︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'ROLEX_TEAM')..')'
status  = '\n*◈︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *◈︙اسم المستخدم »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *◈︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'ROLEX_TEAM')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *◈︙اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'ROLEX_TEAM')..')'..'\n*◈︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'ROLEX_TEAM')..')'
local iduser = result.sender_user_id_
...
{{text = '𝙎𝙤𝙪𝙧𝘾𝙚 𝙍𝙤𝙡𝙚𝙭.', url="t.me/ROLEX_TEAM"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
inline = {
{{text = 'sᴏᴜʀᴄʀ ʀᴏʟᴇх',url='http://t.me/ROLEX_TEAM'}},
}
