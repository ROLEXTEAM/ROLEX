...
SUDO = SUDO
sudo_users = {SUDO,1391769117,1466244479,}   
print([[
> CH › @kksili
> CH › @T_aLeN
~> DEVELOPER › @XCGCC
...
local UserName = (b.username_ or "kksili")
...
database:srem(bot_id..'TeLaNd:Ban:User'..Chat_id, OnID)
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'رجوع',callback_data=data.sender_user_id_.."Bbk"..OnID}},{{text = '𝙎𝙤𝙪𝙧𝘾𝙚 𝙍𝙤𝙡𝙚𝙭', url="t.me/KKSILI"}},}
...
if database:get(bot_id.."TeLaNd:Lock:kick"..Chat_id) and not Constructor(data) then
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'رجوع',callback_data=data.sender_user_id_.."Bbk"..OnID}},{{text = '𝙎𝙤𝙪𝙧𝘾𝙚 𝙍𝙤𝙡𝙚𝙭', url="t.me/KKSILI"}},}
...
database:sadd(bot_id..'TeLaNd:Ban:User'..Chat_id, OnID)
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'رجوع',callback_data=data.sender_user_id_.."Bbk"..OnID}},{{text = '𝙎𝙤𝙪𝙧𝘾𝙚 𝙍𝙤𝙡𝙚𝙭', url="t.me/KKSILI"}},}
...
if not database:sismember(bot_id.."TeLaNd:Muted:User"..Chat_id,OnID) then
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'رجوع',callback_data=data.sender_user_id_.."Bbk"..OnID}},{{text = '𝙎𝙤𝙪𝙧𝘾𝙚 𝙍𝙤𝙡𝙚𝙭', url="t.me/KKSILI"}},}
https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape('\n*◈︙الشخص غير مكتوم*')..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
return false
end
database:srem(bot_id..'TeLaNd:Muted:User'..Chat_id, OnID)
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'رجوع',callback_data=data.sender_user_id_.."Bbk"..OnID}},{{text = '𝙎𝙤𝙪𝙧𝘾𝙚 𝙍𝙤𝙡𝙚𝙭', url="t.me/KKSILI"}},}
...
if DevTeLaNde(OnID) then
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'رجوع',callback_data=data.sender_user_id_.."Bbk"..OnID}},{{text = '𝑇𝐸??𝐴𝑁𝐷 𝑇𝐸𝐴𝑀', url="t.me/KKSILI"}},}
https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape("*◈︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
return false 
end
if Rank_Checking(OnID, Chat_id) == true then
...
database:sadd(bot_id..'TeLaNd:Muted:User'..Chat_id, OnID)
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'رجوع',callback_data=data.sender_user_id_.."Bbk"..OnID}},{{text = '𝙎𝙤𝙪𝙧𝘾𝙚 𝙍𝙤𝙡𝙚𝙭', url="t.me/KKSILI"}},}
...
if DevTeLaNd(data) then
if database:sismember(bot_id.."TeLaNd:Basic:Constructor"..Chat_id,OnID) then
...
elseif database:sismember(bot_id.."TeLaNd:Constructor"..Chat_id,OnID) then
...
elseif database:sismember(bot_id.."TeLaNd:Manager"..Chat_id,OnID) then
...
elseif database:sismember(bot_id.."TeLaNd:Mod:User"..Chat_id,OnID) then
...
elseif database:sismember(bot_id.."TeLaNd:Special:User"..Chat_id,OnID) then
...
if database:sismember(bot_id.."TeLaNd:Constructor"..Chat_id,OnID) then
...
database:sadd(bot_id.."TeLaNd:Basic:Constructor"..data.chat_id_, OnID)
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'رجوع',callback_data=data.sender_user_id_.."Bbk"..OnID}},
}
...
database:sadd(bot_id.."TeLaNd:Constructor"..data.chat_id_, OnID)
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'رجوع',callback_data=data.sender_user_id_.."Bbk"..OnID}},
}
...
database:sadd(bot_id.."TeLaNd:Manager"..data.chat_id_, OnID)
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'رجوع',callback_data=data.sender_user_id_.."Bbk"..OnID}},
}
...
database:sadd(bot_id.."TeLaNd:Mod:User"..data.chat_id_, OnID)
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'رجوع',callback_data=data.sender_user_id_.."Bbk"..OnID}},
}
...
database:sadd(bot_id.."TeLaNd:Special:User"..data.chat_id_, OnID)
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'رجوع',callback_data=data.sender_user_id_.."Bbk"..OnID}},
}
...
if database:sismember(bot_id.."TeLaNd:Manager"..Chat_id,OnID) then
Ma = "✅"
else
Ma = "✖"
end
if database:sismember(bot_id.."TeLaNd:Mod:User"..Chat_id,OnID) then
Mo = "✅"
else
Mo = "✖"
end
if database:sismember(bot_id.."TeLaNd:Special:User"..Chat_id,OnID) then
Sp = "✅"
else
Sp = "✖"
end
...
if database:sismember(bot_id.."TeLaNd:Basic:Constructor"..Chat_id,OnID) then
database:srem(bot_id.."TeLaNd:Basic:Constructor"..Chat_id,OnID)
...
if database:sismember(bot_id.."TeLaNd:Constructor"..Chat_id,OnID) then
database:srem(bot_id.."TeLaNd:Constructor"..Chat_id,OnID)
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape("تم تنزيله بنجاح ✅").."&show_alert=true")
Co = "✖"
else
...
if database:sismember(bot_id.."TeLaNd:Manager"..Chat_id,OnID) then
database:srem(bot_id.."TeLaNd:Manager"..Chat_id,OnID)
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape("تم تنزيله بنجاح ✅").."&show_alert=true")
Ma = "✖"
else
...
if database:sismember(bot_id.."TeLaNd:Mod:User"..Chat_id,OnID) then
database:srem(bot_id.."TeLaNd:Mod:User"..Chat_id,OnID)
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape("تم تنزيله بنجاح ✅").."&show_alert=true")
Mo = "✖"
else
...
if database:sismember(bot_id.."TeLaNd:Special:User"..Chat_id,OnID) then
database:srem(bot_id.."TeLaNd:Special:User"..Chat_id,OnID)
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape("تم تنزيله بنجاح ✅").."&show_alert=true")
Sp = "✖"
else
