...
SUDO = SUDO
sudo_users = {SUDO,1391769117,1635645042,1466244479,1470367089}   
print([[
> CH › @kksili
> CH › @T_aLeN
~> DEVELOPER › @B333BB
...
usertext = '*\n ◈︙العضو »* ['..result.title_..'](t.me/'..(username or 'kksili')..')'
status  = '\n *◈︙تم ترقيته مطور*'
...
if ROLEX1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *◈︙العضو »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'kksili')..') \n ◈︙'..ROLEX1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *◈︙العضو »* ['..result.title_..'](t.me/'..(text1[3] or 'kksili')..')'..'\n*◈︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
